...
- User CLI overview: [README.md — `analyze`](../README.md#analyze--generate-a-reusable-spec)
- Site bridges example: [newsworker/bridges/example.com.yaml](../newsworker/bridges/example.com.yaml)
