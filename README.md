...
[Read the Docs](https://qddate.readthedocs.org/en/latest/).


## Features

* Identifies news blocks on webpages using date patterns. More than 348 date patterns supported. Uses [qddate](https://github.com/ivbeg/qddate)
...
The easiest way is to use the `newsworker.FeedExtractor` class,
and it's `get_feed` function.

See the documentation for `newsworker.extractor.FeedExtractor` and `newsworker.finder.FeedsFinder`.
...
* [qddate](https://pypi.python.org/pypi/qddate) is a module for data processing

* [pyparsing](https://pypi.python.org/pypi/pyparsing) is a module for advanced text processing.

* lxml is a module for xml parsing. ([lxml](https://pypi.python.org/pypi/lxml))
...
[![Join the chat at https://gitter.im/newsworker/Lobby](https://badges.gitter.im/newsworker/Lobby.svg)](https://gitter.im/newsworker/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
